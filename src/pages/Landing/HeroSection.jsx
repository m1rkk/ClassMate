...
export default function HeroSection(props) {
    ...
    <div className="w-[94%] w-max-screen m-0 bg-contain bg-no-repeat bg-center aspect-[23/10] mt-20"
         style={{ backgroundImage: `url(${BgRectangle})` }}>
            ...
            <img src="src/assets/imgs/calendarImg.png" alt="" className="w-3/13 relative left-4/5 bottom-1/2 z-2" />
        <div className="w-full h-1.5 bg-linear-to-r from-[#D0A4FA] to-[#A1E3F1] relative bottom-3/5 z-1"></div>
