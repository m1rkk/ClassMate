...
export default function DashboardButton ({text,goTo}){
    ...
    return(
            <button className={`bg-white text-lg flex flex-row items-center justify-center border-none rounded-2xl pt-4 pb-4 w-1/5 gap-8`} onClick={() => {navigate(goTo)}}>{text}<svg width="30%" viewBox="0 0 111 8" fill="none" xmlns="http://www.w3.org/2000/svg">
